      ...
      <div className="flex w-full max-w-sm flex-col items-center gap-7">
        ...
        <div className="flex w-full flex-col gap-6 rounded-2xl border border-slate-200/70 bg-white/90 p-7 shadow-xl shadow-slate-200/50 backdrop-blur-sm">
              ...
              <div className="flex flex-col gap-2.5">
                {googleConfigured && (
                  ...
                  >
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition hover:border-slate-400 hover:shadow"
                    >
                ...
                {linkedInConfigured && (
                  ...
                  >
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#0A66C2] px-3 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-[#004182] hover:shadow"
                    >
          ...
          >
            ...
            <button
              type="submit"
              className="rounded-xl border border-slate-300 px-3 py-2.5 text-sm font-medium text-slate-700 transition hover:border-slate-400 hover:bg-slate-50"
            >
